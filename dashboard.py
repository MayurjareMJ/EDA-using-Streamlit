...
if fl is not None:
    ...
    os.chdir(r"C:\Users\91935\OneDrive\Desktop\completed projects")
    df = pd.read_csv(r"C:\Users\91935\OneDrive\Desktop\completed projects\Dashboard str\Superstore.csv", encoding="ISO-8859-1")
...
with col1:
    date1 = pd.to_datetime(st.date_input("Star Date ", startDate))
...
filtered_df["months_year"] = filtered_df["Order Date"].dt.to_period("M")
...
fig2 = px.line(linechart, x="month_year", y={"Sales": "Amount"}, height=500, width=1000, template="gridon")
...
st.subheader("Hierarchical view if sales using treemap")
